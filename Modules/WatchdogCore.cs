    ...
    public class WatchdogCore
    {
        ...
        private static void MonitorModules()
        {
            while (isActive)
            {
                try
                {
                    ...
                    // Check for modules that need restarting
        ...
        private static void CheckProcessIntegrity()
        {
            while (isActive)
            {
                try
                {
                    // Check if our main process is still running
        ...
        private static void MonitorMutexes()
        {
            while (isActive)
            {
                try
                {
                    // Check if our mutexes are still valid
                    foreach (var mutexName in ModuleMutexes)
                    {
                        ...
                        else
                        {
                            ...
                            if (error == 5) // Access denied - mutex exists and is owned
                            {
                                // This is normal - mutex is being used by the module
                            }
                            else
                            {
